...
It is required to install "make" for windows in order to run this server.

To do so, you should have chocolatey installed on your system. Refer [here](https://docs.chocolatey.org/en-us/getting-started) for instructions on how to install chocolatey.

After installing chocolatey, you can install "make" by running `choco install make` in an elevated command prompt.

Then, you can start the live server using `make serve`. Content will be served to `localhost:1313` by default.
